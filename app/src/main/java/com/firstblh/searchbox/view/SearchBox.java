package com.firstblh.searchbox.view;
...
import com.firstblh.searchbox.meterialmenu.MaterialMenuDrawable;
import com.firstblh.searchbox.meterialmenu.MaterialMenuView;

import java.util.ArrayList;
import java.util.List;

import com.firstblh.searchbox.widget.SearchBox.animation.ReverseInterpolator;
import com.firstblh.searchbox.widget.SearchBox.animation.SupportAnimator;
import com.firstblh.searchbox.widget.SearchBox.animation.ViewAnimationUtils;
...
//		this.mic = (ImageView) findViewById(R.id.mic);
        ...
        materialMenu.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (searchOpen) {
                    Log.e("searchBox", "materialMenu onclick");
                    toggleSearch();
                } else {
